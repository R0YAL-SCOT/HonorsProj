...
def flags():
    ...
    parser.add_argument("-O", metavar="function", action='stored_false', required=False, help="Use OpenVAS")
    parser.add_argument("-B", metavar="function", action='stored_false', required=False, help="Use BloodHound")
    parser.add_argument("-N", metavar="function", action='stored_false', required=False, help="Use Nmap")
    #target information
